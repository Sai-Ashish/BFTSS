...
from topk_freeze import ALL_LAYERNORM_LAYERS, get_parameter_names


def create_recadam_and_scheduler(model, pretrained_model, model_args, train_args, max_steps):

    optimizer_kwargs = {"lr": train_args.learning_rate,
        "betas": (train_args.adam_beta1, train_args.adam_beta2),
        "eps": train_args.adam_epsilon,
        "anneal_k": model_args.anneal_k,
        "anneal_t0": model_args.anneal_t0
        }
    ...
    optimizer_grouped_parameters = [
        {
            "params": [p for n, p in model.named_parameters() if
                        n in decay_parameters and 'bert' in n],
            "weight_decay": train_args.weight_decay,
            "pretrain_params": [p_p for p_n, p_p in pretrained_model.named_parameters() if
                                p_n in decay_parameters and 'bert' in p_n]
        },
        {
            "params": [p for n, p in model.named_parameters() if
                       n in decay_parameters and 'bert' not in n],
            "weight_decay": train_args.weight_decay,
            "anneal_w": 0.0,
            "pretrain_params": [p_p for p_n, p_p in pretrained_model.named_parameters() if
                                p_n in decay_parameters and 'bert' not in p_n]
        },
        {
            "params": [p for n, p in model.named_parameters() if
                       n not in decay_parameters and 'bert' in n],
            "weight_decay": 0.0,
            "pretrain_params": [p_p for p_n, p_p in pretrained_model.named_parameters() if
                                p_n not in decay_parameters and 'bert' in p_n]
        },
        {
            "params": [p for n, p in model.named_parameters() if
                       n not in decay_parameters and 'bert' not in n],
            "weight_decay": 0.0,
            "anneal_w": 0.0,
            "pretrain_params": [p_p for p_n, p_p in pretrained_model.named_parameters() if
                                p_n not in decay_parameters and 'bert' not in p_n]
        }
    ]

    optimizer = RecAdam(optimizer_grouped_parameters, **optimizer_kwargs)
